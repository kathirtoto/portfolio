...
class Config:
    ...
    MAIL_USERNAME = (os.getenv("MAIL_USERNAME") or os.getenv("EMAIL_USERNAME") or os.getenv("MAIL_USER") or os.getenv("EMAIL_USER", "")).strip()
    MAIL_PASSWORD = (os.getenv("MAIL_PASSWORD") or os.getenv("EMAIL_PASSWORD") or os.getenv("MAIL_PASS") or os.getenv("EMAIL_PASS", "")).strip()
    MAIL_TO = (os.getenv("MAIL_RECEIVER") or os.getenv("EMAIL_RECEIVER") or os.getenv("MAIL_TO") or os.getenv("EMAIL_TO", "kathiresantoto@gmail.com")).strip()
